...
//	 }
	...
	@PostMapping("/saveQuyen")
	public String saveQuyen(@ModelAttribute("quyen") @Valid Quyen quyen, BindingResult bindingResult) {
	...
	@PostMapping("/updateQuyen")
	public String updateQuyen(@ModelAttribute("quyen") @Valid Quyen quyen, BindingResult bindingResult) {
		if (bindingResult.hasErrors()) 
		{
